...
public class CatalogController {
    ...
    public Crop addCrop(@RequestBody CropRequest request, Authentication auth) {
        checkAdmin(auth);
    ...
    @PostMapping("/fertilizer")
    @ResponseStatus(HttpStatus.CREATED)
    public Fertilizer addFertilizer(@RequestBody FertilizerRequest request, Authentication auth) {
        checkAdmin(auth);
